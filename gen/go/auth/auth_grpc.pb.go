...
const (
	...
	Auth_SetAdmin_FullMethodName     = "/Auth/SetAdmin"
...
func (c *authClient) GetPublicKey(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetPublicKeyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServer) GetPublicKey(context.Context, *emptypb.Empty) (*GetPublicKeyResponse, error) {
